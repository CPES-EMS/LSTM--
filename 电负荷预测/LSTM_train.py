...
if __name__ == "__main__":
    ...
    raw_data = df
    new_order = ['year', 'month', 'day', 'hour', 'load_value', 'weekend', 'weekend_sat', 'weekend_sun']  # 将"..."替换为原来的列名及其顺序
    data = raw_data[new_order]

    # print(data)

    # try:
    #     # 调整列的顺序，将新列插入到合适的位置
    #     new_order = ['year', 'month', 'day', 'hour', '电负荷kW', 'weekend', 'weekend_sat',
    ...
    # 定义余弦退火学习率调整器
    scheduler = CosineAnnealingLR(optimizer, T_max=1000, eta_min=0.001)
